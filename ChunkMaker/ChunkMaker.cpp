// chunkmaker.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CchunkmakerApp, CWinApp)
...
// 유일한 CchunkmakerApp 개체입니다.

CchunkmakerApp theApp;


// CchunkmakerApp 초기화

BOOL CchunkmakerApp::InitInstance()
{
