...
char *snr1[]={
	...
	"8","크어어어... 누구냐? 이 보물에 손대는 자는...","죽음으로 죄를 사죄하라!!!","",
	...
	"10","과연 그렇군.","화재를 보고서는 즐기고 있다니!","당신들이 방화범이 틀림없군.",
	"2","허억~ 진짜 화재였어?","","",
	...
	"12", "안녕하십까? 여러분.", "오늘은 저희 술집의 술먹기 대회가 있습니다.", "상품으로는 바람의 신발 한켤레!",
	"1", "좋았어!", "참가하자!", "",
	"12", "방법은 간단합니다.", "술 8병을 10초 이내에 모두 마시면 됩니다.", "단 한병을 마실 때마다 방향키가 바뀌니 주의하십시오!",
	"12", "그럼 시작합니다!!!", "", "",
	"12", "축하합니다. 여기 상인 <바람의 신발>입니다!!!", "", "",
	"12", "안 됐군요. 실패입니다.", "다음기회를 이용해 주십시오.", "",
	"1", "", "", "",
	"1", "", "", "",
	"1", "", "", "",
	"1", "", "", "",
